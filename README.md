...
📍 **Web3 Builder** | 🤖 **AI Native Builder** | 🚀 **Product Engineer**
...
> Building AI Growth Agents for different platforms, exploring the intersection of AI Agents and Web3.
...
#### Stacks I work with
[![Stacks I work with](https://skillicons.dev/icons?i=postgres,mysql,sqlite,supabase,redis,nginx,linux,nodejs,grafana,prometheus,docker,kubernetes,githubactions,git,github,postman,figma,cloudflare,vscode,sublime,bash,ipfs,vercel,aws,gcp)](https://jacklee.io)
...
- **Building AI-native tools** - Creating growth agents that automate and enhance social media workflows
- **Exploring AI + Web3** - Bridging intelligent agents with decentralized ecosystems
- **Shipping fast** - From idea to product, powered by agentic engineering
...
- 🎯 **[ClawMoney Skill](https://github.com/jackleeio/clawmoney-skill)** - ClawMoney skill for AI agents to earn crypto rewards
- 🔍 **[SkillFeed](https://github.com/jackleeio/skill-feed)** - Turn failures into ranked skill recommendations for AI agents
- 📷 **[Scan to Skill](https://github.com/jackleeio/scan-to-skill)** - Scan a QR code and auto-install ClawHub skills
- 🎴 **[Skill QR Card](https://github.com/jackleeio/skill-qr-card)** - Generate shareable QR card images for ClawHub skills
- 🆔 **[XID Protocol](https://github.com/XIDProtocol)** - Key infra enabling Web3 mass adoption on 𝕏
- 💸 **[XMoney](https://github.com/XMoney-Protocol)** - Send crypto to any 𝕏 user, including bulk transfers and payouts to retweeters
...
![GitHub Contribution Graph](https://ghchart.rshah.org/jackleeio)
